...
const char descriptor_table_protodef_model_2eproto[] =
  ...
  "umber\030\002 \002(\007\022\014\n\004Data\030\003 \002(\014\"\035\n\014VectorStrin"
  "g\022\r\n\005peers\030\001 \003(\t*3\n\rDatagramaType\022\007\n\003ACK"
...
::google::protobuf::internal::DescriptorTable descriptor_table_model_2eproto = {
  ...
  "model.proto", &assign_descriptors_table_model_2eproto, 189,
};
...
void Datagrama::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000002u) {
    ::google::protobuf::internal::WireFormatLite::WriteFixed32(2, this->packnumber(), output);
  }
...
::google::protobuf::uint8* Datagrama::InternalSerializeWithCachedSizesToArray(
  ...
  // required fixed32 PackNumber = 2;
  if (cached_has_bits & 0x00000002u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFixed32ToArray(2, this->packnumber(), target);
  }
